  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[70vh] bg-gradient-to-br from-gray-900 via-yellow-900/20 to-black overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(255,193,7,0.15),transparent_50%),radial-gradient(circle_at_80%_70%,rgba(255,gradient(circle_at_20%_30%,rgba(255,193,7,0.15),transparent_50%),radial-gradient(circle_at_80%_70%,rgba(255,152,0,0.12),transparent_50%)]"></div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 drop-shadow-2xl">
            Device Broken?
            <span className="block text-3xl md:text-4xl font-light bg-gradient-to-r from-gray-200 via-white to-gray-300 bg-clip-text text-transparent mt-2">
              We've Got You Covered
            </span>
          </h2>
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
            Professional repairs at your doorstep. No need to leave your home or office.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button
              size="lg"
              className="bg-gradient-to-r from-white to-gray-100 text-black hover:from-gray-100 hover:to-white font-semibold px-8 py-4 text-lg shadow-2xl hover:shadow-white/20 transition-all duration-300 transform hover:scale-105"
            >
              <Link href="/repairs">Book House Call - R49</Link>
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-gradient-to-r hover:from-white hover:to-gray-100 hover:text-black bg-transparent font-semibold px-8 py-4 text-lg shadow-xl hover:shadow-white/10 transition-all duration-300 transform hover:scale-105"
            >
      ...
      <footer className="bg-gradient-to-br from-black via-gray-900 to-black text-white py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Your premium destination for technology and style. Quality products, professional service.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li>Email: info@rkdsholdings.co.za</li>
                <li className="text-white font-semibold">House Calls: R49</li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2024 RKDS Holdings. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
